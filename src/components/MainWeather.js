...
export default function MainWeather(props) {
    ...
    return (
        <div style={{ textAlign: 'center' }}>
            <img className="main-weather" alt="MainWeather" src={img} />
            <p className="weather-status">{props.weather.description}</p>
            <p className="weather-temp"><span className="bolder">Temperature</span> <span className="from">{props.weather.main.temp_min}&deg;</span> to <span className="to">{props.weather.main.temp_max}&deg;</span>C</p>
